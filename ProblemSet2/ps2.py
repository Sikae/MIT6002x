...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        self.width = width
        self.height = height
        self.room = [[False for y in range(self.height)] for x in range(self.width)]
    ...
    def getRandomPosition(self):
        ...
        """
        x = list(i for i in range(self.width))
        y = list(i for i in range(self.height))
    ...
    def isPositionInRoom(self, pos):
        ...
        """
        return pos.getX() >= 0 and pos.getX() < self.width and pos.getY() < self.height and pos.getY() >= 0
    ...
    for trial in range(num_trials):
        ...
        while room.getNumCleanedTiles() / room.getNumTiles() < min_coverage:
            ...
            for i in range(num_robots):
                ...
                room.cleanTileAtPosition(robots[i].getRobotPosition())
...
print  runSimulation(1, 1.0, 5, 5, 0.78, 100, StandardRobot)
